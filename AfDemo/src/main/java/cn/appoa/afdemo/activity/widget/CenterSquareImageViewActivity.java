...
import cn.appoa.afui.widget.image.CenterSquareImageView;
...
public class CenterSquareImageViewActivity extends BaseActivity
    ...
    public BaseTitlebar initTitlebar() {
        return new DefaultTitlebar.Builder(this)
                .setTitle("CenterSquareImageView")
    ...
    private CenterSquareImageView iv_image_center;
    ...
    public void initView() {
        ...
        iv_image_center = (CenterSquareImageView) findViewById(R.id.iv_image_center);
