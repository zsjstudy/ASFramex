...
public abstract class PullToRefreshAdapterViewBaseFragment<T, V extends AbsListView>
     ...
     * @return
     */
    public abstract AfAdapter<T> initAdapter();
     ...
     * @return
     */
    protected boolean isRefreshRequestClear() {
        return false;
    }
    ...
    public void onSuccessResponse(String response) {
        ...
        if (datas != null && datas.size() > 0) {
            ...
            if (isShowToast()) {
                ...
                ToastUtils.showShort(getActivity(), message, false);
            }
        }
    }
