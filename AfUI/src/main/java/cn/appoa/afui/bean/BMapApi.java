...
public class BMapApi implements Serializable {
    ...
    public BMapCountryList content;
     ...
     * @return
     */
    public static List<BMapProvinceList> getProvinceList(Context context) {
        List<BMapProvinceList> list = new ArrayList<BMapProvinceList>();
        String json = JsonUtils.getJsonString(context, "region.json");
