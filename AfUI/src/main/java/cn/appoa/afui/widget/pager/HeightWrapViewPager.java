...
public class HeightWrapViewPager extends ViewPager {
    ...
    public void setBanner(ArrayList<String> images) {
        ...
        if (images != null && images.size() > 0) {
            AfApplication.imageLoader.downloadImage(images.get(0), new LoadingBitmapListener() {
                @Override
    ...
    private void initViewPager() {
        setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                ...
                AfApplication.imageLoader.downloadImage(images.get(position), new LoadingBitmapListener() {
                    @Override
